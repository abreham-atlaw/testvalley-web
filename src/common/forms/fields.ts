...
export default class Field<T>{
	...
	public validator: CallableFunction | null;
	public liveValidate: boolean;

	constructor(required: boolean = true, validator: CallableFunction|null = null, liveValidate: boolean = true, validationGap: number = 2000){
