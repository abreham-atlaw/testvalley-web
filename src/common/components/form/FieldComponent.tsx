...
export abstract class FieldComponent<T, P extends FieldComponentProps<T>> extends React.Component<P, FieldComponentState<T>>{
	...
	private sync?: CallableFunction
	private externalOnChanged?: CallableFunction
	...
	protected abstract constructInputNode(value: T|null, callback: CallableFunction): React.ReactNode
