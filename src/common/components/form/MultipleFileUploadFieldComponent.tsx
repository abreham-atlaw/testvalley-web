...
export class MultiFileUploadViewModel extends AsyncViewModel<MultiFileUploadState>{
	...
	constructor(state: MultiFileUploadState, stateSetter: CallableFunction, fileStorage: FileStorage){
		super(state, stateSetter)
		this.fileStorage = fileStorage;
	}

	async upload(value: File[], callback: CallableFunction) {
...
export default class MultiFileUploadFieldComponent extends FieldComponent<string[], MutliFileUploadFieldComponentProps>{
	...
	private async onFileChanged(value: FileList | null | undefined, callback: CallableFunction){
	...
	protected constructInputNode(value: string[] | null, callback: CallableFunction): ReactNode {
